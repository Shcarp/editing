...
pub fn wasm_main() {
    ...
    match init_result {
        Ok(_) => {
            ...
            //     rect.animate_to(initial_animation, 3.0, helper::easing::ease_out_quad);

            //     let shrink_animation = AnimationParams::default()
            //         .height(40.0)
            //         .width(40.0)
            //         .rotation((i as f64) * 7.2);
            //     rect.animate_to(shrink_animation, 2.0, helper::easing::ease_in_out_cubic);
            ...
            //         .width(100.0)
            //         .rotation((i as f64) * 7.2); 
            //     rect.animate_to(expand_animation, 2.5, helper::easing::ease_out_quad);
